...
აქ არის განახლებული README.md ფაილის შიგთავსი ქართულად, თქვენი ექსპერიმენტის შედეგების ჩათვლით:

Walmart მაღაზიის გაყიდვების პროგნოზირება - LightGBM მოდელის ექსპერიმენტი
🎯 ექსპერიმენტი 9: LightGBM წინასწარი დამუშავების პაიპლაინით
ეს README დეტალურად აღწერს მე-9 ექსპერიმენტს, რომელიც ფოკუსირებულია Walmart-ის მაღაზიის გაყიდვების პროგნოზირების გადაწყვეტაზე, LightGBM მანქანური სწავლების ბიბლიოთეკის გამოყენებით. LightGBM, როგორც გრადიენტური ბუსტინგის ჩარჩო, ცნობილია თავისი სისწრაფითა და ეფექტურობით დიდ მონაცემთა ნაკრებზე, რაც მას მიმზიდველ ალტერნატივად აქცევს დროითი სერიების პროგნოზირებისთვის. ამ ექსპერიმენტის მიზანი იყო LightGBM-ის გამოყენება იმავე ყოვლისმომცველი წინასწარი დამუშავების პაიპლაინთან ერთად, რაც Prophet-ის შემთხვევაში გამოვიყენეთ, რათა შეგვეფასებინა მისი ეფექტურობა გლობალური მოდელირების მიდგომით.
...
LightGBM მოდელის პარამეტრები

ფიჩერების შერჩევა

აუტლაიერების დამუშავება

შეწონილი საშუალო აბსოლუტური შეცდომა (WMAE)
...
MLflow / DagsHub თრექინგი

დასკვნა და შემდეგი ნაბიჯები

💡 პროექტის მიმოხილვა
ამ პროექტის მიზანია Walmart-ის მაღაზიების ყოველკვირეული გაყიდვების ზუსტი პროგნოზირება. წინა ექსპერიმენტში Prophet-ის სერიების დონის მოდელირების შემდეგ, ამ ექსპერიმენტში განვიხილეთ LightGBM-ს, როგორც გლობალურ მოდელს. LightGBM-ის მიდგომა შესაძლებელს ხდის ყველა მაღაზია-განყოფილების მონაცემების ერთ მოდელში გაერთიანებას, რაც პოტენციურად იძლევა უკეთესი განზოგადების საშუალებას, რადგან ის სწავლობს ნიმუშებს მთელ მონაცემთა ნაკრებზე.
...
LightGBM მოდელის პარამეტრები
LightGBM Regressor-ისთვის გამოყენებული იქნა შემდეგი პარამეტრები, რომლებიც შეირჩა ეფექტურობისა და საწყისი კარგი შესრულებისთვის:
...
აუტლაიერების დამუშავება
აუტლაიერები მოიხსნა მხოლოდ ტრენინგის მონაცემებიდან, მაღაზიის ტიპის მიხედვით, ისევე როგორც Prophet-ის ექსპერიმენტში. ამ ექსპერიმენტში 28,279 აუტლაიერი იქნა ამოღებული ტრენინგის ნაკრებიდან.

შეწონილი საშუალო აბსოლუტური შეცდომა (WMAE)
პირველადი შეფასების მეტრიკა, შეწონილი საშუალო აბსოლუტური შეცდომა (WMAE), გამოითვალა Walmart-ის კონკურსის სპეციფიკური ფორმულის გამოყენებით:

სადღესასწაულო კვირები შეწონილია 5-ჯერ მეტად, ვიდრე ჩვეულებრივი კვირები.

ჩვეულებრივი კვირები შეწონილია 1-ჯერ.

ასევე, გამოითვალა MAE, RMSE და R² მეტრიკები.

📊 ექსპერიმენტის შედეგები
LightGBM მოდელმა აჩვენა ძლიერი შესრულება, როგორც ტრენინგის, ისე ვალიდაციის მონაცემებზე, რაც მიუთითებს კარგ განზოგადების უნარზე.

აგრირებული ტრენინგის მეტრიკები (In-Sample)
ეს მეტრიკები ასახავს მოდელის ეფექტურობას იმ მონაცემებზე, რომლებზეც ის გატრენინგდა.
...
აგრირებული ვალიდაციის მეტრიკები (Out-of-Sample)
ეს მეტრიკები ასახავს მოდელის განზოგადების უნარს უცნობ მონაცემებზე.
...
დასკვნა Overfitting-ზე: WMAE-ის თანაფარდობა (ვალიდაცია/ტრენინგი) 1.07 მიუთითებს იმაზე, რომ მოდელი კარგად განზოგადდება უცნობ მონაცემებზე და არ აჩვენებს მნიშვნელოვან ოვერფიტინგს. R²-ის მცირე სხვაობა (0.0031) ასევე ადასტურებს ამ დაკვირვებას.

LightGBM ექსპერიმენტმა აჩვენა ძალიან პერსპექტიული შედეგები, მიაღწია დაბალ WMAE-ს და მაღალ R²-ს ვალიდაციის ნაკრებზე, მინიმალური ოვერფიტინგით.
